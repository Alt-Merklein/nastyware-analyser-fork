...
# ————————————————————————————————
    ...
    with open(csv_path, 'a', newline='') as csvfile:
        ...
        writer.writerow([
            ...
            REP,
            train_raw_samples,
            0, # duplicated_vectors, (zerado porque esse teste sempre gera do zero a matriz de distância)
            0, # unique_vectors, (zerado porque esse teste sempre gera do zero a matriz de distância)
